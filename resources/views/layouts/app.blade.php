                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.venues.index') }}">Venue</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <form action="{{ route('events.search') }}" method="GET" class="d-flex">
                        <input class="form-control me-2" type="search" name="search" placeholder="Event Search" aria-label="Search">
